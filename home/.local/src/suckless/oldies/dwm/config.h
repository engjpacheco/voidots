//This is my personal ricing from DWM
...
static const char buttonbar[]       = ""; /*DWM icon from xmenu */
...
const char *spcmd1[] = {TERMINAL, "-n", "spterm", "-g", "120x15", NULL };
...
static Key keys[] = {
	...
	{ MODKEY,			XK_F8,		spawn,		SHCMD("mbsync -a") },
